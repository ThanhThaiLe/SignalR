...
namespace chatbox.data.service
{
    ...
    {
        private readonly IChatBoxDbContextFactory _context;

        public UserService(
            IChatBoxDbContextFactory chatboxDbContextFactory)
        {
            _context = chatboxDbContextFactory;
        }
